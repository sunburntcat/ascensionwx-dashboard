...
export async function getActions( begin_time_iso_date ) {
  ...
  try {
    ...
    if((await fetchPromise).status == 502){
...
export function getData(bunk, devname) {
  ...
  export async function postMapData(content="weather") {
    // const url = "https://telos.caleos.io/" //https://telos.caleos.io/    //https://api.kandaweather.net/v1/chain/get_table_rows
    ...
    const response = await fetch(url_mainnet, {
        method: "POST",
