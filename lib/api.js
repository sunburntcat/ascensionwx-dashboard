...
export async function getCurrentWeather( lower_bound=0 ) {
    const url = "https://telos.caleos.io/v1/chain/get_table_rows" //https://telos.caleos.io/    //https://api.kandaweather.net/v1/chain/get_table_rows
    const url_mainnet = "https://kandaweather-mainnet.ddns.net/v1/chain/get_table_rows"
    let postData = "{\"code\":\"ascendweathr\",\"table\":\"weather\",\"scope\":\"ascendweathr\",\"index_position\":\"first\",\"lower_bound\":" +
                 lower_bound +
                  ",\"json\":\"true\",\"limit\":100}"
...
export async function getCurrentSensors( lower_bound=0 ) {
    const url = "https://telos.caleos.io/v1/chain/get_table_rows" //https://telos.caleos.io/    //https://api.kandaweather.net/v1/chain/get_table_rows
    const url_mainnet = "https://kandaweather-mainnet.ddns.net/v1/chain/get_table_rows"
    let postData = "{\"code\":\"ascendweathr\",\"table\":\"sensorsv3\",\"scope\":\"ascendweathr\",\"index_position\":\"first\",\"lower_bound\":" +
                 lower_bound +
                  ",\"json\":\"true\",\"limit\":100}"
