        ...
        <div className=''>
            <div className="p-12">
                ...
                <div className="flex items-baseline text-gray-900">
                    <span className="ml-1 text-xl font-normal text-gray-500 ">_devname:</span>
                    <span className="text-3xl font-semibold"> xxxxxxxxx</span>
                </div>
                <ul role="list" className="my-7 space-y-5">
                    <li className="flex space-x-3">
                        ...
                        <span className="text-base font-normal leading-tight text-gray-500 ">trx_id: data</span>
                    </li>
