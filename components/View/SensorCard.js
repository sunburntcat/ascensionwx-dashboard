            ...
            <div className="p-12 ml-5">
                ...
                <ul role="list" className="my-7 space-y-5 ml-10">
                    ...
                    <li className="flex space-x-3">
                        ...
                        <span className="text-base font-normal leading-tight text-gray-500">Lastest temperaure: {props.sensor.lo}</span>
                    </li>
                    <li className="flex space-x-3">
                        ...
                        <span className="text-base font-normal leading-tight text-gray-500">Last uploaded: {props.sensor.lo} ago</span>
                    </li>
                    <li className="flex space-x-3">
